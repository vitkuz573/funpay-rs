...
impl FunPayClient {
    ...
    pub async fn fetch_seller_profile(&self, seller_id: u64) -> Result<Seller, FunPayError> {
        ...
        Parser::new().parse_seller_profile(&html).ok_or_else(|| FunPayError::Parse(ParseError::MissingField("Seller".into())))
    }
    ...
    pub async fn fetch_user_profile(&self, user_id: u64) -> Result<User, FunPayError> {
        ...
        Parser::new().parse_user_profile(&html).ok_or_else(|| FunPayError::Parse(ParseError::MissingField("User".into())))
    }
